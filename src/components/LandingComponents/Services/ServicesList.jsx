            ...
            <div className="group">
              <div className="group-hover:border-2 group-hover:border-[#C9E065] p-2">
                ...
                >
                  ...
                  />
                  <h2 className="font-bold font-normal  font-intr text-[23px] leading-[26px] uppercase pt-8">
                    {item?.heading}
                  </h2>
                  <div className="border-2 my-6 border-[#1F3D64] w-[80px]"></div>
                  <p className="text-medium font-mons text-[16px] leading-[30px]">
                    {item?.desc}
                  </p>
                  <div className="relative xl:max-w-[205px] md:max-w-[205px] max-w-[185px]   ">
                    <button className="group-hover:bg-[#1F3D64] group-hover:text-[#C9E065] bg-transparent text-[#1F3D64] rounded-full lg:text-[16px] text-[14px] border font-normal font-mons mt-10 uppercase px-8 py-2.5">
                      View Services
                    </button>
                    <div className="border rounded-full absolute top-[60%] right-0 group-hover:bg-[#C9E065] group-hover:text-[#1F3D64] bg-[#1F3D64] text-white">
