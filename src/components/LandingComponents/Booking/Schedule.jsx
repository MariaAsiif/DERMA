    ...
    <>
      ...
      <div className=' relative '>
        <div className='bg-[#C9E065]  lg:h-[400px] max-w-[1000px] ml-auto lg:py-0 md:py-4 py-4 '>
          ...
          <div className='absolute xl:top-[22.5%] top-10 left-[8%] xl:max-w-[500px] md:max-w-[400px]'>
            ...
            <p className='text-[#5C636E] leading-[28px]  font-normal font-sans  text-[15px]'>Our team of experts is ready to help you achieve your goals. Schedule your appointment today and start your journey towards a healthier and happier life!</p>
