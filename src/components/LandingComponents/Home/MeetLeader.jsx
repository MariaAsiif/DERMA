  ...
  return (
    <>
      <div className='container mx-auto  xl:px-10 px-5 pt-[80px] mb-[80px] relative'>
        <div className='border-4 lg:h-[400px] z-50 rounded-2xl  border-[#C9E065] lg:px-0 px-3 lg:py-0 py-3'>
          <div className='max-w-[800px] lg:ml-[40%] md:ml-[45%] lg:pt-0 md:pt-0 pt-[100%]'>
            ...
            <Link to="/booking">
              <button className='rounded-full  lg:text-[16px] text-[14px] font-bold font-sans mt-3 bg-[#1F3D64] text-[#C9E065] hover:bg-[#C9E065] hover:text-[#1F3D64] uppercase px-8 py-3 '>book an appointment
              </button>
            </Link>
