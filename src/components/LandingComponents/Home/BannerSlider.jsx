                            ...
                            <div className='absolute  lg:top-60 md:top-[30%] top-[20%] right-1  lg:right-16 md:right-5'>
                                <div className='max-w-[800px] m-auto  '>
                                    ...
                                    <div className='pt-[30px]'>
                                        ...
                                        <button className='rounded-full font-bold font-sans  mx-3 bg-[#1F3D64] text-[#C9E065] lg:text-auto md:text-auto text-[10px] hover:bg-[#C9E065] hover:text-[#1F3D64] uppercase lg:px-8 md:px-8 px-2 lg:py-3 md:py-3 py-1 '>book now</button>
                                    </div>
                                </div>
                            </div>
                        </div>
