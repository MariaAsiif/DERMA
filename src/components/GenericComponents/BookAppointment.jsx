    ...
    <>
      <div className='container mx-auto text-center xl:px-10 px-5 pt-[80px]'>
        <div className='grid grid-cols-2 gap-5'>
          <div className='bg-[#1F3D64] rounded-2xl  p-3 '>
            <div className='pt-3 relative h-full'>
              ...
              <button className='rounded-full w-full font-semibold font-sans left-0 absolute bottom-5  bg-white text-[#1F3D64] text-[14px]  uppercase px-8 py-3 '>request an appointment</button>
            </div>
          </div>
          <div>
            <img src={footerImg} alt={footerImg} className='object-cover' />
          </div>
