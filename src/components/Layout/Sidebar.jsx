...
import RequestForCall from "../LandingComponents/Personal/RequestForCall";
  ...
  return (
    <>
      <div>
        ...
        <div
          className={`fixed inset-0 bg-slate-900 bg-opacity-30 z-50  transition-opacity duration-200 ${
        ...
        {showPopup && (
          <Popup
            ...
            data={
              <RequestForCall onCloseRequestModal={() => setShowPopup(false)} />
            }
          />
        )}
        ...
        <div
          id="sidebar"
          ref={sidebar}
          className={`flex flex-col  absolute z-50 border-r  left-0 top-0 lg:left-0  
      ${
        sidebarOpen ? "opacity-100" : "opacity-0 pointer-events-none"
      } lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64  lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-white  border-l py-4 transition-all duration-200 ease-in-out ${
        ...
        >
          ...
          <div className=" mb-10 pr-6 sm:px-2">
            ...
            <div className="flex justify-start items-start ml-3">
              <BsArrowLeft
                className="border text-[30px] rounded-full border-black hover:text-white p-1"
            ...
            <div className="h-full pb-2">
              {location === "/personal" ? (
                <ul className="flex  items-center flex-col text-[16px] ">
                  <li className="pt-4">
                    <h2
                      className={` pb-3 px-3 cursor-pointer ${
                        location === "/"
                          ? "border-b-4 font-bold border-[#C9E065]"
                          : "font-normal"
                      }`}
                    >
                      HOME
                  ...
                  <li>
                    <div className="border rounded-full py-2 bg-[#1F3D64] text-[#C9E065] px-5">
                ...
                <ul className="flex  items-center flex-col text-[16px] ">
                  <li className="pt-4 " id="nav-item">
                    <Link
                      ...
                      to="/"
                    >
                      <h2 className={` pb-3 px-3 cursor-pointer uppercase`}>
                        HOME
                      </h2>
                    </Link>
                  </li>
                  ...
                  <li className="pt-3 " id="nav-item">
                    ...
                    >
                      <h2
                        className={` pb-3 mb-2 px-3 cursor-pointer uppercase`}
                      >
                        Contacts Us
                      </h2>
                    </Link>
